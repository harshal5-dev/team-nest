/**
 * AvatarGallery — 40 self-contained SVG avatars grouped by category.
 *
 * Each avatar is a pure inline data-URI so the app has zero external
 * dependencies for profile pictures.
 *
 * Usage:
 *   import { AVATARS, AVATAR_CATEGORIES } from "@/components/AvatarGallery";
 */
...
export const DEFAULT_AVATAR = svg(
  `<defs><linearGradient id="bg" x1="0" y1="0" x2="0.5" y2="1"><stop offset="0%" stop-color="#4f46e5"/><stop offset="50%" stop-color="#7c3aed"/><stop offset="100%" stop-color="#a78bfa"/></linearGradient></defs><circle cx="50" cy="50" r="50" fill="url(#bg)"/><circle cx="50" cy="50" r="42" fill="none" stroke="#e0e7ff" stroke-width="0.5" opacity="0.3"/><circle cx="50" cy="50" r="34" fill="none" stroke="#e0e7ff" stroke-width="0.4" opacity="0.2"/><circle cx="50" cy="38" r="13" fill="#e0e7ff"/><path d="M50 53c-15 0-26 8-26 18v29h52V71c0-10-11-18-26-18z" fill="#e0e7ff"/><circle cx="50" cy="38" r="10.5" fill="#f8fafc"/><circle cx="45.5" cy="36" r="1.5" fill="#3730a3"/><circle cx="54.5" cy="36" r="1.5" fill="#3730a3"/><path d="M46.5 42q3.5 2.5 7 0" stroke="#3730a3" stroke-width="1.2" fill="none" stroke-linecap="round"/><circle cx="42" cy="38" r="2.5" fill="#fde68a" opacity="0.15"/><circle cx="58" cy="38" r="2.5" fill="#fde68a" opacity="0.15"/>`,
);
