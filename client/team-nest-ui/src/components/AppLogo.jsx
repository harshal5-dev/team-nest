  ...
  const content = (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 rounded-xl opacity-0 group-hover/logo:opacity-100 transition-opacity duration-500 overflow-hidden">
          <div className="absolute inset-0 -translate-x-full group-hover/logo:translate-x-full transition-transform duration-1000 bg-linear-to-r from-transparent via-white/30 to-transparent" />
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <span className="inline-block text-primary transition-all duration-300 group-hover/logo:translate-x-1 group-hover/logo:scale-110 group-hover/logo:text-violet-500">
            Nest
          </span>
        </span>
        <span
